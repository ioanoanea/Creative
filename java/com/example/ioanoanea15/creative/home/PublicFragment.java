...
public class PublicFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        friends = view.findViewById(R.id.btn_friends);
        listview = view.findViewById(R.id.nv_list);
        refreshLayout = view.findViewById(R.id.refresh);
        nothing = view.findViewById(R.id.nothing);

        URL_DISPLAY = getString(R.string.server) + "/display_public_pictures.php";
        ...
        friends.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                getFragmentManager().beginTransaction().replace(R.id.home_container, new FollowingFragment()).addToBackStack(null).commit();
            }
        });
        ...
        refreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                getFragmentManager().beginTransaction().replace(R.id.home_container, new PublicFragment()).addToBackStack(null).commit();
    ...
    public class CustomAdapter extends RecyclerView.Adapter<ListViewHolder>{
        ...
        public void onBindViewHolder(@NonNull final ListViewHolder listViewHolder, final int position) {
            ...
            final HashMap<String, String> user = listViewHolder.sessionManager.getUserDetail();
            ...
            listViewHolder.btn_send.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ((HomeActivity)getActivity()).sendMessage(user.get(listViewHolder.sessionManager.ID),UserId.get(position),
                            user.get(listViewHolder.sessionManager.NAME) + " " + user.get(listViewHolder.sessionManager.LAST_NAME),
                            Images.get(position),"1",URL_SEND_MESSAGE);
                    ((HomeActivity)getActivity()).sendMessage(user.get(listViewHolder.sessionManager.ID),UserId.get(position),
                            user.get(listViewHolder.sessionManager.NAME) + " " + user.get(listViewHolder.sessionManager.LAST_NAME),
                            "i like your photo","0",URL_SEND_MESSAGE);
