...
public class FollowingFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        pb = view.findViewById(R.id.btn_public);
        listview = view.findViewById(R.id.nv_list);
        refreshLayout = view.findViewById(R.id.refresh);
        nothing = view.findViewById(R.id.nothing);

        URL_DISPLAY = getString(R.string.server) + "/display_following.php";
    ...
    private void getPictures(final String user_id, final String URL) {
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            e.printStackTrace();
                            ((HomeActivity)getActivity()).displayError(e.toString());
                        }
                    }
                },
